/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 0a920b6605a52fe8bb765a1b2b09184d)
// Runtime types generated with workerd@1.20260911.1 2026-06-24 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	AUTH_KV: KVNamespace;
	CACHE_KV: KVNamespace;
	DOWNLOAD_BUCKET: R2Bucket;
	DB_CENTRAL_ALERTS: D1Database;
	DB_EXTENSIONS: D1Database;
	PROFILE_CREATION_RATE_LIMITER: RateLimit;
	EXTENSIONS_V2_EMAIL_PROVIDER: "mxroute";
	EXTENSIONS_V2_MXROUTE_SERVER: "wednesday.mxrouting.net";
	EXTENSIONS_V2_MXROUTE_USERNAME: "extensions@fossbilling.org";
	GITHUB_TOKEN: string;
	ASSERTION_SIGNING_SECRET: string;
	EXTENSIONS_V2_MXROUTE_PASSWORD: string;
	EXTENSIONS_REVALIDATE_SECRET: string;
	EXTENSIONS_FRONTEND: Fetcher /* extensions */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXTENSIONS_V2_EMAIL_PROVIDER" | "EXTENSIONS_V2_MXROUTE_SERVER" | "EXTENSIONS_V2_MXROUTE_USERNAME" | "GITHUB_TOKEN" | "ASSERTION_SIGNING_SECRET" | "EXTENSIONS_V2_MXROUTE_PASSWORD" | "EXTENSIONS_REVALIDATE_SECRET">> {}
}
